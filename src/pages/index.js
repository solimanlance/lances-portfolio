      ...
      <section id="projects" className="min-h-[300px] flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              { name: "Project One", description: "Brief description of this project" },
              { name: "Project Two", description: "Brief description of this project" },
              { name: "Project Three", description: "Brief description of this project" },
              { name: "Project Four", description: "Brief description of this project" },
              { name: "Project Five", description: "Brief description of this project" },
              { name: "Project Six", description: "Brief description of this project" }
            ].map((project, index) => (
